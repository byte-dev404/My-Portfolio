...
function Projects() {
    ...
    function handleImageClick(e) {
        ...
        const id = Number(e.target.dataset.id) -1
        setCard(projects[id]);
    }
    ...
    return(
        <>
            ...
            <div onClick={handleImageClick} className={styles['projects-container']}>
                <img data-id="1"
